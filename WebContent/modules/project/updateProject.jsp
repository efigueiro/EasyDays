...
<body>
	<div id="container">
		...
		<div id="body">
			<div id="content">
				<div id="toolBar">
					<a href="<%=request.getContextPath()%>/modules/project/retrieveProject.jsp">Return</a>
				</div>
				<p>${message}</p>
				<fieldset>
					<legend>Update project</legend>
					<form action="/EasyDays/updateProject" method="post">
						<p>
							 <input name="projectId" id="projectId" value="${selectedProject.projectId}" type="hidden" style="width: 250px;" />
						</p>
					
						<p>
							<label for="name">Name:</label> <input name="name" id="name"
								value="${selectedProject.name}" type="text" style="width: 250px;" />
						</p>

						<p>
							<label for="description">Description:</label>
							<textarea cols="47" rows="11" name="description" id="description">${selectedProject.description}</textarea>
						</p>
