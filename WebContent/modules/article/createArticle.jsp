...
<div id="wrap">
	...
	<div id="main">
		...
		<div id="leftside">
		<h2><%=Msg.getProperty("page.createArticle")%></h2>
			<form style="margin-top:30px; margin-left:20px;" action="/EasyDays/createArticle" method="post">
				<ul style="list-style-type:none;">
					...
					<li style="margin-top:15px;"><input name="createArticle" class="button" value="<%=Msg.getProperty("button.createArticle")%>" type="submit" /></li>
				</ul>
			</form>
		</div>
	</div>
