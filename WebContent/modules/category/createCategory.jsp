...
<body>
	<div id="container">
		...
		<div id="body">
			<div id="content">
				<div id="toolBar">
					<a href="<%=request.getContextPath()%>/modules/category/retrieveCategory.jsp">Search Category</a>
				</div>
				<p>${message}</p>
				<fieldset>
					<legend>Create category</legend>
					<form action="/EasyDays/createCategory" method="post">
						<p>
						...
						<p>
							<input name="createCategory" style="margin-left: 150px;"
								class="formbutton" value="Create Category" type="submit" />
						</p>
					</form>
				</fieldset>
			</div>
